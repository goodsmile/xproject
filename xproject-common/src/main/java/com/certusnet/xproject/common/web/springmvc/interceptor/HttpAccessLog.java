...
public class HttpAccessLog<T> {
	...
	public String toString() {
		return "HttpAccessLog [title=" + title + ", uri=" + uri + ", method=" + method + ", requestHeader="
				+ requestHeader + ", requestContentType=" + requestContentType + ", requestParameter="
				+ requestParameter + ", accessUser=" + accessUser + ", accessTime=" + accessTime + ", clientIpAddr="
				+ clientIpAddr + ", serverIpAddr=" + serverIpAddr + ", accessBeginMillis=" + accessBeginMillis
				+ ", accessEndMillis=" + accessEndMillis + ", processTime1=" + processTime1 + ", processTime2="
				+ processTime2 + ", loggingCompleted=" + loggingCompleted + ", asynRequest=" + asynRequest
				+ ", responseContentType=" + responseContentType + ", responseResult=" + responseResult + "]";
	}
